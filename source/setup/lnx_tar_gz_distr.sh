...
cp -a ../../docs $tmp_dir$proj_dir_name/local/share/$proj_dir_name/doc/
cp -a ../../samples $tmp_dir$proj_dir_name/local/share/$proj_dir_name/doc/
...
if [ "$project_name" = "b1ig" ]
then
  cp b1ig.desktop $tmp_dir$proj_dir_name/share/applications
fi

#strip copied executables
${6}strip --strip-all $tmp_dir$proj_dir_name/local/bin/b1i
${6}strip --strip-all $tmp_dir$proj_dir_name/local/bin/b1iu
if [ "$project_name" = "b1ig" ]
then
