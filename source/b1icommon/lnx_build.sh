...
if [ -f "$1/source/b1icommon/get_git_rev.sh" ]
then
  . $1/source/b1icommon/get_git_rev.sh "$1/source/b1icommon" "$8"
fi

if [ -f "$1/source/b1icommon/lnx_${platform}_${compiler}_env.sh" ]
then
  . $1/source/b1icommon/lnx_${platform}_${compiler}_env.sh
  export B1_WX_CONFIG
fi
